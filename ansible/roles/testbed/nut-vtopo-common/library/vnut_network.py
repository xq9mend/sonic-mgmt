...
def action_cleanup(module):
    ...
    tg_prefix = "vtg{}".format(testbed_name[:6])
    ...
    for line in stdout.splitlines():
        ...
        # Match testbed-scoped link veth pairs (e.g. vlmytestb_0-a) or TG veths (e.g. vtgmytes_0a)
        if iface.startswith(link_prefix) or iface.startswith(tg_prefix):
